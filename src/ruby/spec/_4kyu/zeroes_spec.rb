...
RSpec.describe "Zeroes tests" do
    it "should be solved with direct computation" do
      expect(zeroes(10, 10)).to eq(2), "10_10! has 2 zeroes"
      expect(zeroes(16, 16)).to eq(3), "10_16! has 3 zeroes"
    end
  
    it "should pass quirks" do
    ...
    it "should consider a full base decomposition" do
    ...
    it "should pass [relatively] big prime in base" do
